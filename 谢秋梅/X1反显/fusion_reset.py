...
def trans_3D_data(data_ids, dataset_id, team_id, dataset_result_id, class_name_id_mapping, name_attr_mapping):
    ...
    for sli in range(0, len(data_ids), 500):
        ...
        d_object_count = []
        d_validity2 = []
        for data_id in tqdm(data_ids[sli:sli+500], desc=f"{dataset_id}"):
...
def main(team_id):
    ...
    for dataset_id in [90404]:
        if dataset_id in has_dataset_ids:
            continue
        else:
