...
def write_result(json_dir: str, result_path, check_file):
    ...
    count_3d = 0
    mark_err = []
    for json_file in tqdm(list_files(json_dir, '.json')):
        ...
        for box in boxs:
            ...
            if track_id not in id_list:
                ...
                if type == "DontCare":
                    ...
                    if obj_type == '3d':
                        one_box_err = f"作业id{data_id} | 第{frame_number}帧 | {int_id}号框3D框打了忽略标签"
                    ...
                    obj_type = box['objType']
                    if obj_type == 'rect':
                        one_box_err = f"作业id{data_id} | 第{frame_number}帧 | {int_id}号框2D框打了非忽略标签"
                        mark_err.append(one_box_err)
                        continue
                    else:
                        if box['attrs']:
...
if __name__ == "__main__":
    ...
    # result_json_path = r"C:\Users\EDY\Downloads\json_43585_more_20221228174954"
    # output_path = r"C:\Users\EDY\Downloads\json_43585_more_20221228174954\out"
    # check_file = r"C:\Users\EDY\Downloads\c.json"
