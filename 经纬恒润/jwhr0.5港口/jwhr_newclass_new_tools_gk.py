    ...
    for file in tqdm(list_files(in_path)):
        ...
        if not json_content:
            ...
            if not json_content['result']:
                ...
                # pcd_path = r"D:\Desktop\BasicProject\王满顺\经纬恒润\私有化\old_lidar\lidar\LIDAR_UPPER_CLOUD"
                ...
                if not os.path.exists(pcd_file):
                    ...
                    for box in boxs:  # 读取每个3D框数据
                        ...
                        if class_type == '补框属性':
                            ...
                            if point_num < wide:
                                border_err_str = f"作业ID:{data_id}-第{frame}帧-{int_id}号框点数({point_num})不符合要求"
                    ...
                    if lap:  # 如果有框重叠
                        overlap_err_str = f"作业ID:{data_id}-第{frame}帧有框重叠"
...
if __name__ == "__main__":
    ...
    # check_file = r"D:\Desktop\BasicProject\王满顺\经纬恒润\私有化\推送结果\detection.check.txt"
    # result_json_path = r"D:\Desktop\BasicProject\王满顺\经纬恒润\私有化\推送结果 - 副本\jsons"
